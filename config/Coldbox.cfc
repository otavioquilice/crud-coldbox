component {
	...
	function configure(){
		...
		datasources = {
			myDataSource = {
				class      = "coldbox.system.orm.hibernate.Hibernate",
				username   = "root",
				password   = "Joaninha@123",
				dialect    = "org.hibernate.dialect.MySQLDialect", // O dialeto varia com o banco de dados que você está usando
				jdbcdriver = "com.mysql.jdbc.Driver", // O driver varia com o banco de dados que você está usando
				logSQL     = true, // Opcional, exibirá SQLs no console
				dbcreate   = "update" // Opcional, use "update" para criar tabelas automaticamente
			}
    	};
	}
